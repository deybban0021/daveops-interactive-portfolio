...
function BackgroundField() {
  return (
    <group position={[0.26, -0.06, -0.22]} rotation={[0, 0, -0.001]}>
      ...
      <mesh position={[-0.2, -0.72, -0.03]}>
        <planeGeometry args={[9.4, 2.7]} />
        <meshBasicMaterial color="#0b1421" transparent opacity={0.06} />
      </mesh>
      <mesh position={[-1.6, -0.24, -0.02]}>
        <planeGeometry args={[3.4, 1.82]} />
        <meshBasicMaterial color="#122133" transparent opacity={0.05} />
      </mesh>
      <mesh position={[0.72, 0.54, -0.02]}>
        <planeGeometry args={[5.1, 2.6]} />
        <meshBasicMaterial color="#122133" transparent opacity={0.04} />
      </mesh>
      <mesh position={[3.04, -0.42, -0.01]}>
        <planeGeometry args={[4.0, 1.8]} />
        <meshBasicMaterial color="#16304b" transparent opacity={0.04} />
      </mesh>
      ...
      <mesh position={[-2.92, 1.18, -0.01]}>
        <boxGeometry args={[1.54, 0.014, 0.004]} />
        <meshBasicMaterial color="#2a5f8d" transparent opacity={0.1} />
      </mesh>
      <mesh position={[-2.24, 1.18, 0]}>
        <boxGeometry args={[0.54, 0.014, 0.004]} />
        <meshBasicMaterial color="#7fe6ff" transparent opacity={0.22} />
      </mesh>
      <mesh position={[4.0, -1.02, -0.01]}>
        <boxGeometry args={[2.02, 0.01, 0.004]} />
        <meshBasicMaterial color="#214666" transparent opacity={0.08} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group position={node.position} rotation={node.rotation} scale={node.scale}>
      ...
      <mesh position={[0, 0, 0.016]}>
        ...
        <meshBasicMaterial color="#132337" transparent opacity={0.32 * node.emphasis} />
      </mesh>
      <mesh position={[0, 0.34, 0.018]}>
        <boxGeometry args={[2.08, 0.022, 0.006]} />
        <meshBasicMaterial color="#43cbff" transparent opacity={0.44 * node.emphasis} />
      </mesh>
      <mesh position={[-0.7, 0.12, 0.02]}>
        <boxGeometry args={[0.18, 0.18, 0.006]} />
        <meshBasicMaterial color="#17324d" transparent opacity={0.34 * node.emphasis} />
      </mesh>
      <mesh position={[-0.7, 0.12, 0.026]}>
        <boxGeometry args={[0.08, 0.08, 0.006]} />
        <meshBasicMaterial color="#54d4ff" transparent opacity={0.38 * node.emphasis} />
      </mesh>
      <mesh position={[-0.02, 0.16, 0.022]}>
        <boxGeometry args={[0.88, 0.034, 0.006]} />
        <meshBasicMaterial color="#eef7ff" transparent opacity={0.26 * node.emphasis} />
      </mesh>
      <mesh position={[0.08, 0.06, 0.022]}>
        <boxGeometry args={[1.12, 0.026, 0.006]} />
        <meshBasicMaterial color="#8dcaf0" transparent opacity={0.18 * node.emphasis} />
      </mesh>
      <mesh position={[0.02, -0.05, 0.022]}>
        <boxGeometry args={[1.78, 0.012, 0.006]} />
        <meshBasicMaterial color="#3c82b0" transparent opacity={0.08 * node.emphasis} />
      </mesh>
      <mesh position={[0.0, -0.18, 0.02]}>
        <boxGeometry args={[1.42, 0.6, 0.006]} />
        <meshBasicMaterial color="#0f1d2d" transparent opacity={0.18 * node.emphasis} />
      </mesh>
      <mesh position={[0.98, -0.26, 0.014]}>
        <boxGeometry args={[0.03, 0.08, 0.01]} />
        <meshBasicMaterial color="#54d4ff" transparent opacity={0.18 * node.emphasis} />
      </mesh>
    </group>
  )
}
...
function AutomationDiagram() {
  ...
  return (
    <group scale={1.12} rotation={[-0.045, 0, -0.004]} position={[0.52, 0.02, 0]}>
      <BackgroundField />
